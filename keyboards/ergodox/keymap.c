...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    KC_EQUAL,       KC_1,           KC_2,           KC_3,           KC_4,           KC_5,           KC_ESCAPE,                                      KC_WWW_REFRESH, KC_6,           KC_7,           KC_8,           KC_9,           KC_0,           KC_MINUS,
    ...
    KC_LSHIFT,      KC_Z,           KC_X,           KC_C,           KC_V,           KC_B,           KC_AUDIO_VOL_DOWN,                                KC_MEDIA_NEXT_TRACK,KC_N,           KC_M,           KC_COMMA,       KC_DOT,         KC_SLASH,       KC_RSHIFT,
    OSL(1),         KC_GRAVE,       KC_BSLASH,      KC_LEFT,        KC_RIGHT,                                                                                                       KC_UP,          KC_DOWN,        KC_LBRACKET,    KC_RBRACKET,    OSL(2),
                                                                                                    CTL_T(KC_NO),   ALT_T(KC_NO),   KC_RALT,        RCTL_T(KC_NO),
                                                                                                                    KC_HOME,        KC_PGUP,
